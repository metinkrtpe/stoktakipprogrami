...
<div class="wrapper">
    <div class="sidebar">
        ...
        <div class="profile_info">
            <div class="profile_img" ><i class="fa fa-truck" aria-hidden="true"></i>
    ...
    <i class="fa fa-refresh" aria-hidden="true" id = "depo-icon"></i>
    
    <h6 class = "depobilgi">Depo Bilgileri</h6>
    <table class = "depo">
        <thead>
            <tr>
                <th>Depo Adı</th>
